    ...
    public class ByteBuffer : Stream {
        ...
        */    
        ...
        public static void SetCacheSize(int size) {
            ...
            Array.Copy(byteCache, 0, tmpCache, 0, byteCacheSize);
            byteCache = tmpCache;
            byteCacheSize = size;
        }
            ...
            if (d < 1.0) {
                ...
                if (v < byteCacheSize && byteCache[v] != null) {
                    if (buf != null) {
                        ...
                        string tmp = EncodingTools.ConvertToString(byteCache[v], null);
                        if (negative) tmp = "-" + tmp;
                        return tmp;
                    }
                }
        ...
        public int Size {
            ...
            set {
                if (value > count || value < 0)
                    throw new ArgumentOutOfRangeException("the.new.size.must.be.positive.and.lt.eq.of.the.current.size");
                count = value;
            }
        }
