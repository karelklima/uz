...
/*
 * $Id: Utilities.cs 605 2013-09-12 14:01:48Z pavel-alay $
 * 
 *
...
namespace UZ.PDF {
    ...
    */
    ...
    class Utilities {
	    ...
	    * @return
	    */
	    public static bool CheckTrueOrFalse(Settings attributes, String key) {
        ...
        */
        ...
        public static String ConvertToHex(byte[] bytes) {
	        ...
	        return EncodingTools.ConvertToString(buf.ToByteArray(), null).ToUpper();
	    }
