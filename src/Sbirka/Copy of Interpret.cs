...
namespace UZ.Sbirka
{
    class OldInterpret
    {
        ...
        public static Text InterpretujPredpis(Predpis predpis)
        {
            ...
            OldInterpret instance = new OldInterpret(predpis.Adapter, extrakt, false);
            return instance.text;
        }

        public static Text InterpretujPredpis(IAdapter adapter, StructuredDocument text)
        {
            OldInterpret instance = new OldInterpret(adapter, text, true);
            return instance.text;
        }
        ...
        private OldInterpret(IAdapter adapter, StructuredDocument dokument, bool castZakona)
        {
        ...
        private int ShodaSukcese(int cisloOdstavce, int idSekce)
        {
            ...
            return makroSukcese[idSekce].Contains(id) ? id : -1;
        }
        ...
        private void ZpracujPredpis()
        {
            ...
            while (iterator < odstavce.Count)
            {
                ...
                {
                    Sekce.Zasobnik cit = ZpracujNovelizaci(odstavec);
            ...
            ZpracujMakroSekce(noveOdstavce);
        }

        private Sekce.Zasobnik ZpracujNovelizaci(StructuredDocument.Paragraph novyOdstavec)
        {
            ...
            Text kontejner = OldInterpret.InterpretujPredpis(this.adapter, novelizace);
            //ukazatel.AddSubsekce(kontejner.Obsah);
            return kontejner.Obsah;

           
        }

        private void ZpracujMakroSekce(List<StructuredDocument.Paragraph> obsah)
        {
